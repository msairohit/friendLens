-- Migration: Add item_id to get_network_reviews return columns
-- 1. Recreate get_network_reviews function with item_id included
...
BEGIN
  ...
  SELECT g.review_id, g.reviewer_name, g.reviewer_pseudonym, g.is_anonymous, g.item_title, g.item_type, g.item_poster_url, g.item_release_year, g.rating, g.comment, g.depth, g.created_at, g.updated_at, g.item_id
  FROM (
